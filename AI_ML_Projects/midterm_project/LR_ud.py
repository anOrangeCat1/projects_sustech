...
In this python file, the Logistic Regression method and unbalanced 
dataset (breast_cancer_data_357B_100M.csv) are used.

Dataset:breast_cancer_data_357B_100M.csv
    contains 357 benign and 100 malignant samples.
    357+100=457 samples in total
    For the malignant samples are few, the 70 malignant smaples are be sured to train the model
    and 273 benign samples are also used to train
    114 test: 30 malignan, 84 benign
    """
